...
public class MarvelParser {
   ...
   */
  public static void parseData(String filename, Set<Node<String>> characters,
      Map<Node<String>, List<Node<String>>> books) throws MalformedDataException {
    ...
    try {
        ...
        while ((inputLine = reader.readLine()) != null) {
            ...
            Node<String> character = new Node<String>(tokens[0]);
            Node<String> book = new Node<String>(tokens[1]);

            // Add the parsed data to the character and book collections.
            characters.add(character);
            if (!books.containsKey(book)) {
                books.put(book, new ArrayList<Node<String>>());
            }
